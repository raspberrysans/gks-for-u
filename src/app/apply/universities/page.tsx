...
export default function UniversitiesPage() {
 ...
 {choices.map((c, i) => (
 <div key={i} className="rounded-2xl border border-[color:var(--line)] p-4 ">
 ...
 {warnNoTypeB && (
 <p className="mt-4 rounded-lg border border-[color:var(--warn)] bg-[color:var(--warn-soft)] p-3 text-sm text-[color:var(--warn)] ">
